...
import (
	...
	delivery "github.com/googleinterns/knative-continuous-delivery/pkg/client/informers/externalversions/delivery"
...
func (f *sharedInformerFactory) Delivery() delivery.Interface {
	return delivery.New(f, f.namespace, f.tweakListOptions)
}
