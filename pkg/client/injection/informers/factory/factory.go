...
import (
	...
	externalversions "github.com/googleinterns/knative-continuous-delivery/pkg/client/informers/externalversions"
	client "github.com/googleinterns/knative-continuous-delivery/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/googleinterns/knative-continuous-delivery/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
