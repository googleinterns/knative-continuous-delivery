...
var policiesResource = schema.GroupVersionResource{Group: "delivery.knative.dev", Version: "v1alpha1", Resource: "policies"}

var policiesKind = schema.GroupVersionKind{Group: "delivery.knative.dev", Version: "v1alpha1", Kind: "Policy"}
